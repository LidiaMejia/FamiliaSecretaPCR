...
if(isset($_POST["btnAgregar"]))
{
    ...
    $conexion = initDB();
    $count    = checkIfCelExistsCursoApocalipsis($txtNum, $conexion);

    //Si aún no está registrado, se guardan los datos
    if($count == 0)
    {
        $res = insertCursoApocalipsis($txtNombre, $txtNum, $txtEmail, $conexion);

        //Error
        if($res == 1)
        {
            echo "<script> alert('Ocurrió un error al ingresar la Inscripción. Por favor intente de nuevo.'); window.location='cursoApocalipsisForm.php;</script>";
        }
        else
        {
...
<head>
    ...
    <title>Curso del Apocalipsis</title>
            ...
            <div class="col-12">
                ...
                <div class="card shadow lg p-3 mb-5 bg-white">
                    ...
                    <div class="card-header text-center h1-form">
                        <h1 style="font-size: 2rem;">Inscripción para el Curso del Apocalipsis</h1>
                        <h5>Inicia Martes 5 de septiembre (Todos los martes de 7:00 PM a 9:00 PM)</h5>
                    </div>
                    ...
                    <div class="card-body d-flex justify-content-center align-items-center flex-wrap text-center">
                        ...
                        <form action="cursoApocalipsisForm.php" id="cursoApocalipsisRegister" method="POST">
