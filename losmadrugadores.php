...
if(isset($_POST["btnAgregar"]))
{
    ...
    $conexion = initDB();
    $count    = checkIfCelExistsMadrugadores($txtNum, $conexion);

    //Si aún no está registrado, se guardan los datos
    if($count == 0)
    {
        $res = insertMadrugadores($txtNombre, $txtNum, $txtEmail, $conexion);

        //Error
        if($res == 1)
        {
            echo "<script> alert('Ocurrió un error al ingresar la Inscripción. Por favor intente de nuevo.'); window.location='losmadrugadores.php;</script>";
        }
        else
        {
            ...
            <div class="col-12">
                ...
                <div class="card shadow lg p-3 mb-5 bg-white">
                    ...
                    <div class="card-header text-center h1-form">
                        <h1>Inscripción Rama Masculina Los Madrugadores</h1>
                        <h5>Inicia: Sábado 26 de agosto a las 6:00 AM (Reunión cada 15 días)</h5>
                    </div>
                    ...
                    <div class="card-body d-flex justify-content-center align-items-center flex-wrap text-center">
                        ...
                        <form action="losmadrugadores.php" id="madrigadoresRegister" method="POST">
