...
if(isset($_POST["btnAgregar"]))
{
    ...
    $conexion = initDB();
    $count    = checkIfCelExistsAdoradores($txtNum, $conexion);

    //Si aún no está registrado, se guardan los datos
    if($count == 0)
    {
        $res = insertAdoradores($txtNombre, $txtNum, $txtEmail, $conexion);

        //Error
        if($res == 1)
        {
            echo "<script> alert('Ocurrió un error al ingresar la Inscripción. Por favor intente de nuevo.'); window.location='adoradoresForm.php;</script>";
        }
        else
        {
            ...
            <div class="col-12">
                ...
                <div class="card shadow lg p-3 mb-5 bg-white">
                    ...
                    <div class="card-header text-center h1-form">
                        <h1>Inscripción de Adoradores del Santísimo Sacramento</h1>
                    </div>
                    ...
                    <div class="card-body d-flex justify-content-center align-items-center flex-wrap text-center">
                        ...
                        <form action="adoradoresForm.php" id="adoradoresRegister" method="POST">
